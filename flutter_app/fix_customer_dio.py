...
with open('lib/core/di/data_sources/dio_client.dart', 'r', encoding='utf-8') as f:
    content = f.read()

# Increase timeouts and add headers
...
with open('lib/core/di/data_sources/dio_client.dart', 'w', encoding='utf-8') as f:
    f.write(content)
