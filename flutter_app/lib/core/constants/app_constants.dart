...
class AppConstants {
  static const String baseUrl = 'https://api.multishop.tchad/api/';
  ...
  static const String apiV3SellerPrefix = 'v3/seller';
  ...
  static const String authVerifyEmailEndpoint = 'auth/verify-email';
  static const String authVerifyPhoneEndpoint = 'auth/verify-phone';
  static const String authRegistrationWithOTPEndpoint = 'auth/registration-with-otp';
  static const String authSocialLoginEndpoint = 'auth/social-login';
  static const String authFirebaseAuthVerifyEndpoint = 'auth/firebase-auth-verify';
  static const String authFirebaseAuthTokenStoreEndpoint = 'auth/firebase-auth-token-store';
  
  static const String vendorRegisterEndpoint = 'v3/seller/registration';
  static const String vendorLoginEndpoint = 'v3/seller/auth/login';
  static const String vendorForgotPasswordEndpoint = 'v3/seller/auth/forgot-password';
  static const String vendorVerifyOTPEndpoint = 'v3/seller/auth/verify-otp';
  static const String vendorResetPasswordEndpoint = 'v3/seller/auth/reset-password';
  static const String vendorFirebaseAuthVerifyEndpoint = 'v3/seller/auth/firebase-auth-verify';
  static const String vendorFirebaseAuthTokenStoreEndpoint = 'v3/seller/auth/firebase-auth-token-store';
  static const String vendorCheckExistEndpoint = 'v3/seller/auth/check-vendor-exist-info';
  
  static const String categoriesEndpoint = 'categories';
  static const String productsEndpoint = 'products';
  static const String shopsEndpoint = 'seller';
  static const String bannersEndpoint = 'banners';
  static const String brandsEndpoint = 'brands';
  static const String flashDealsEndpoint = 'flash-deals';
  static const String dealsEndpoint = 'deals';
  static const String dealOfTheDayEndpoint = 'dealsoftheday';
  
  static const String cartEndpoint = 'cart';
  static const String checkoutEndpoint = 'customer/order/place';
  static const String ordersEndpoint = 'customer/order';
  static const String orderTrackEndpoint = 'order/track';
  
  static const String wishlistEndpoint = 'customer/wish-list';
  static const String compareEndpoint = 'customer/compare';
  static const String couponEndpoint = 'coupon';
  static const String walletEndpoint = 'customer/wallet';
  static const String loyaltyEndpoint = 'customer/loyalty';
  static const String notificationEndpoint = 'notifications';
  static const String addressEndpoint = 'customer/address';
  static const String profileEndpoint = 'customer';
  static const String chatEndpoint = 'customer/chat';
  static const String supportTicketEndpoint = 'customer/support-ticket';
  static const String restockRequestEndpoint = 'customer/restock-requests';
  
  static const String vendorProductsEndpoint = 'v3/seller/products/products';
  static const String vendorOrdersEndpoint = 'v3/seller/orders';
  static const String vendorShopEndpoint = 'v3/seller/shop-info';
  static const String vendorDashboardEndpoint = 'v3/seller/get-earning-statitics';
  static const String vendorCategoriesEndpoint = 'v3/seller/products/categories';
  static const String vendorBrandsEndpoint = 'v3/seller/brands';
  static const String vendorCouponsEndpoint = 'v3/seller/coupon';
  static const String vendorShippingEndpoint = 'v3/seller/shipping';
  static const String vendorShippingMethodEndpoint = 'v3/seller/shipping-method';
  static const String vendorNotificationsEndpoint = 'v3/seller/notification';
  static const String vendorPaymentInfoEndpoint = 'v3/seller/payment-information';
  static const String vendorWithdrawEndpoint = 'v3/seller/balance-withdraw';
  static const String vendorTransactionEndpoint = 'v3/seller/transactions';
  static const String vendorRefundEndpoint = 'v3/seller/refund';
  static const String vendorRestockEndpoint = 'v3/seller/products/restock-request-list';
  static const String vendorChatEndpoint = 'v3/seller/messages';
  static const String vendorDeliveryManEndpoint = 'v3/seller/delivery-man';
  static const String vendorEmergencyContactEndpoint = 'v3/seller/delivery-man/emergency-contact';
  static const String vendorWithdrawMethodEndpoint = 'v3/seller/withdraw-method-list';
  static const String vendorPOSendpoint = 'v3/seller/pos';
  ...
  static const String customerReductionRequestEndpoint = 'customer/orders/{orderId}/request-reduction';
  static const String customerReductionRequestsEndpoint = 'customer/reduction-requests';
  static const String customerReductionRespondEndpoint = 'customer/reduction-requests/{requestId}/respond';
  static const String vendorReductionRequestsEndpoint = 'v3/seller/reduction-requests';
  static const String vendorReductionAcceptEndpoint = 'v3/seller/reduction-requests/{requestId}/accept';
  static const String vendorReductionRefuseEndpoint = 'v3/seller/reduction-requests/{orderId}/refuse';
  static const String vendorReductionCounterOfferEndpoint = 'v3/seller/reduction-requests/{requestId}/counter-offer';
  
  // Order Cancellation
  static const String orderCancelEndpoint = 'customer/order/{orderId}/cancel';
  
  // Door Photo
  static const String doorPhotoUploadEndpoint = 'customer/order/{orderId}/door-photo';
  ...
  static const List<int> reductionTiers = [250, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 5000, 10000];
  ...
  static List<LanguageModel> languages = [
    LanguageModel(languageCode: 'fr', countryCode: 'TD', languageName: 'Français'),
    LanguageModel(languageCode: 'ar', countryCode: 'TD', languageName: 'العربية'),
  ];
...
// Stockage
  ...
  static const String shopUri = 'seller/shop-info';
  
  // Firebase
  static const String firebaseApiKey = 'AIzaSyCFGqSEiWMItei_AFIUgdM53PWrvyGmjFY';
  static const String firebaseProjectId = 'drivevalley-fdb7f';
  static const String firebaseMessagingSenderId = '76471554747';
  static const String firebaseAppId = '1:76471554747:android:3aa5d58a094e2a036d0f9e';
  ...
  static const List<String> videoExtensions = ['mp4', 'mkv', 'avi', 'mov', 'wmv', 'flv', 'webm', 'mpeg', 'mpg', 'm4v', '3gp', 'ogv'];
  static const List<String> imageExtensions = ['png', 'jpg', 'jpeg', 'gif', 'webp'];
  static const List<String> documentExtensions = ['doc', 'docx', 'txt', 'csv', 'xls', 'xlsx', 'pdf'];
  static const List<String> disallowedExtensions = ['php','php3','php4','php5','php7','php8','phtml','phar','asp','aspx','jsp','cgi','pl','py','rb','js','mjs','html','htm','xhtml','sh','bash','bat','cmd','ps1','zsh','ksh','exe','dll','so','bin','msi','app','java','class','jar','7z','gz','bz2','xz','env','ini','conf','config','yml','yaml','log','sql','db','bak','old','swp','tmp'];
  static const List<String> filterTypeList = ['all', 'debit', 'credit'];
  static const List<String> loyaltyEarnTypeList = ['order_place', 'register', 'referred'];
  static const List<String> walletEarnTypeList = ['add_fund', 'refund', 'loyalty_point', 'order_place'];
