import 'package:flutter_sixvalley_ecommerce/features/vendor/product/domain/services/product_service_interface.dart' as v_product_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product/domain/repositories/product_repository.dart' as v_product_repository;
...
import 'package:flutter_sixvalley_ecommerce/features/vendor/review/domain/repositories/product_review_repository.dart' as v_product_review_repository;
...
// --- VENDOR IMPORTS ---
import 'package:flutter_sixvalley_ecommerce/features/vendor/addProduct/controllers/add_product_image_controller.dart' as v_add_product_image_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/addProduct/controllers/add_product_tax_controller.dart' as v_add_product_tax_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/addProduct/controllers/digital_product_controller.dart' as v_digital_product_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/addProduct/controllers/variation_controller.dart' as v_variation_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/ai/controllers/ai_controller.dart' as v_ai_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/ai/domain/repositories/ai_repository.dart' as v_ai_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/ai/domain/repositories/ai_repository_interface.dart' as v_ai_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/ai/domain/services/ai_service.dart' as v_ai_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/ai/domain/services/ai_service_interface.dart' as v_ai_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/controllers/auction_product_controller.dart' as v_auction_product_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/controllers/auction_ai_controller.dart' as v_auction_ai_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/domain/repository/auction_ai_repository.dart' as v_auction_ai_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/domain/repository/auction_ai_repository_interface.dart' as v_auction_ai_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/domain/services/auction_ai_service.dart' as v_auction_ai_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/domain/services/auction_ai_service_interface.dart' as v_auction_ai_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/domain/repository/auction_product_repository.dart' as v_auction_product_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/domain/repository/auction_product_repository_interface.dart' as v_auction_product_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/domain/services/auction_product_service.dart' as v_auction_product_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auction/domain/services/auction_product_service_interface.dart' as v_auction_product_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auth/domain/repositories/auth_repository.dart' as v_auth_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auth/domain/repositories/auth_repository_interface.dart' as v_auth_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auth/domain/services/auth_service.dart' as v_auth_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auth/domain/services/auth_service_interface.dart' as v_auth_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/bank_info/domain/repositories/bank_info_repository_interface.dart' as v_bank_info_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/bank_info/domain/services/bank_info_service.dart' as v_bank_info_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/bank_info/domain/services/bank_info_service_interface.dart' as v_bank_info_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/barcode/controllers/barcode_controller.dart' as v_barcode_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/barcode/domain/repositories/barcode_repository.dart' as v_barcode_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/barcode/domain/repositories/barcode_reposity_interface.dart' as v_barcode_reposity_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/barcode/domain/services/barcode_service.dart' as v_barcode_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/barcode/domain/services/barcode_service_interface.dart' as v_barcode_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/chat/domain/repositories/chat_repository_interface.dart' as v_chat_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/chat/domain/services/chat_service.dart' as v_chat_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/chat/domain/services/chat_service_interface.dart' as v_chat_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/clearance_sale/controllers/clearance_sale_controller.dart' as v_clearance_sale_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/clearance_sale/domain/repositories/clearance_sale_repository.dart' as v_clearance_sale_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/clearance_sale/domain/repositories/clearance_sale_repository_interface.dart' as v_clearance_sale_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/clearance_sale/domain/services/clearance_sale_service.dart' as v_clearance_sale_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/clearance_sale/domain/services/clearance_sale_service_interface.dart' as v_clearance_sale_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/coupon/domain/repositories/coupon_repository_interface.dart' as v_coupon_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/coupon/domain/services/coupon_service.dart' as v_coupon_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/coupon/domain/services/coupon_service_interface.dart' as v_coupon_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/delivery_man/domain/repositories/delivery_man_repository_interface.dart' as v_delivery_man_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/emergency_contract/domain/repositories/emergency_contract_repository_interface.dart' as v_emergency_contract_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/delivery_man/domain/services/delivery_service.dart' as v_delivery_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/delivery_man/domain/services/delivery_service_interface.dart' as v_delivery_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/emergency_contract/domain/services/emergency_contruct_service_interface.dart' as v_emergency_contruct_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/emergency_contract/domain/services/emergency_service.dart' as v_emergency_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/notification/controllers/notification_controller.dart' as v_notification_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/notification/domain/repositories/notification_repository.dart' as v_notification_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/notification/domain/repositories/notification_repository_interface.dart' as v_notification_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/notification/domain/services/notification_service.dart' as v_notification_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/notification/domain/services/notification_service_interface.dart' as v_notification_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/domain/repositories/location_repository_interface.dart' as v_location_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/domain/repositories/order_repository_interface.dart' as v_order_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/domain/services/location_service.dart' as v_location_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/domain/services/location_service_interface.dart' as v_location_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/domain/services/order_service.dart' as v_order_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/domain/services/order_service_interface.dart' as v_order_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_details/controllers/order_details_controller.dart' as v_order_details_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_details/domain/repositories/order_details_repository.dart' as v_order_details_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_details/domain/repositories/order_details_repository_interface.dart' as v_order_details_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_details/domain/services/order_details_service.dart' as v_order_details_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_details/domain/services/order_details_service_interface.dart' as v_order_details_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_edit/controllers/order_edit_controller.dart' as v_order_edit_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_edit/domain/repositories/order_edit_repository.dart' as v_order_edit_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_edit/domain/repositories/order_edit_repository_interface.dart' as v_order_edit_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_edit/domain/services/order_edit_service.dart' as v_order_edit_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_edit/domain/services/order_edit_service_interface.dart' as v_order_edit_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/pos/controllers/barcode_scan_controller.dart' as v_barcode_scan_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/pos/controllers/coupon_discount_controller.dart' as v_coupon_discount_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/pos/domain/repository/cart_repository_interface.dart' as v_cart_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/pos/domain/services/cart_service.dart' as v_cart_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/pos/domain/services/cart_service_interface.dart' as v_cart_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product/controllers/category_controller.dart' as v_category_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product/domain/repositories/category_repository.dart' as v_category_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product/domain/repositories/category_repository_interface.dart' as v_category_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product/domain/repositories/product_repository_interface.dart' as v_product_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product/domain/services/category_service.dart' as v_category_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product/domain/services/category_service_interface.dart' as v_category_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product/domain/services/product_service.dart' as v_product_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product_details/controllers/product_details_controller.dart' as v_product_details_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product_details/domain/repositories/product_details_repository.dart' as v_product_details_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product_details/domain/repositories/product_details_repository_interface.dart' as v_product_details_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product_details/domain/services/product_details_service.dart' as v_product_details_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product_details/domain/services/product_details_service_interface.dart' as v_product_details_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/profile/domain/repositories/profile_repository_interface.dart' as v_profile_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/profile/domain/services/profice_service_interface.dart' as v_profice_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/profile/domain/services/profile_service.dart' as v_profile_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/refund/domain/repositories/refund_repository_interface.dart' as v_refund_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/refund/domain/services/refund_service.dart' as v_refund_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/refund/domain/services/refund_service_interface.dart' as v_refund_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/restock/controllers/restock_controller.dart' as v_restock_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/restock/domain/repositories/restock_repository.dart' as v_restock_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/restock/domain/repositories/restock_repository_interface.dart' as v_restock_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/restock/domain/services/restock_service.dart' as v_restock_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/restock/domain/services/restock_service_interface.dart' as v_restock_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/review/domain/repositories/product_review_repository_interface.dart' as v_product_review_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/review/domain/services/review_service.dart' as v_review_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/review/domain/services/review_service_interface.dart' as v_review_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/settings/domain/repositories/buisness_repository_interface.dart' as v_buisness_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/settings/domain/repositories/business_repository.dart' as v_business_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/pos/domain/repository/cart_repository.dart' as v_cart_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/chat/domain/repositories/chat_repository.dart' as v_chat_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/coupon/domain/repositories/coupon_repository.dart' as v_coupon_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/delivery_man/domain/repositories/delivery_man_repository.dart' as v_delivery_man_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/emergency_contract/domain/repositories/emergency_contact_repository.dart' as v_emergency_contact_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/domain/repositories/location_repository.dart' as v_location_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/domain/repositories/order_repository.dart' as v_order_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/profile/domain/repositories/profile_repository.dart' as v_profile_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/refund/domain/repositories/refund_repository.dart' as v_refund_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/settings/domain/services/business_service.dart' as v_business_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/settings/domain/services/business_service_interface.dart' as v_business_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shipping/domain/repositories/shipping_repository_interface.dart' as v_shipping_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shipping/domain/services/shipping_service.dart' as v_shipping_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shipping/domain/services/shipping_service_interface.dart' as v_shipping_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/addProduct/domain/repository/add_product_repository.dart' as v_add_product_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shipping/domain/repositories/shipping_repository.dart' as v_shipping_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shop/domain/repositories/shop_repository.dart' as v_shop_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/addProduct/domain/repository/add_product_repository_interface.dart' as v_add_product_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/addProduct/domain/services/add_product_service.dart' as v_add_product_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/addProduct/domain/services/add_product_service_interface.dart' as v_add_product_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shop/domain/repositories/shop_repository_interface.dart' as v_shop_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shop/domain/services/shop_service.dart' as v_shop_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shop/domain/services/shop_service_interface.dart' as v_shop_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/splash/domain/repositories/splash_repository.dart' as v_splash_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/bank_info/domain/repositories/bank_info_repository.dart' as v_bank_info_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/splash/domain/repositories/splash_repository_interface.dart' as v_splash_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/splash/domain/services/splash_service.dart' as v_splash_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/splash/domain/services/splash_service_interface.dart' as v_splash_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/transaction/domain/repositories/transaction_repository.dart' as v_transaction_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/auth/controllers/auth_controller.dart' as v_auth_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/settings/controllers/business_controller.dart' as v_business_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/transaction/domain/repositories/transaction_repository_interface.dart' as v_transaction_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/transaction/domain/services/transaction_service.dart' as v_transaction_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/transaction/domain/services/transaction_service_interface.dart' as v_transaction_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/vat_management/controllers/vat_controller.dart' as v_vat_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/vat_management/domain/repositories/vat_repository.dart' as v_vat_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/vat_management/domain/repositories/vat_repository_interface.dart' as v_vat_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/vat_management/domain/services/vat_service.dart' as v_vat_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/vat_management/domain/services/vat_service_interface.dart' as v_vat_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/wallet/controllers/wallet_controller.dart' as v_wallet_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/wallet/domain/repositories/wallet_repository.dart' as v_wallet_repository;
import 'package:flutter_sixvalley_ecommerce/features/vendor/wallet/domain/repositories/wallet_repository_interface.dart' as v_wallet_repository_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/wallet/domain/services/wallet_service.dart' as v_wallet_service;
import 'package:flutter_sixvalley_ecommerce/features/vendor/wallet/domain/services/wallet_service_interface.dart' as v_wallet_service_interface;
import 'package:flutter_sixvalley_ecommerce/features/vendor/pos/controllers/cart_controller.dart' as v_cart_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/chat/controllers/chat_controller.dart' as v_chat_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/coupon/controllers/coupon_controller.dart' as v_coupon_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/delivery_man/controllers/delivery_man_controller.dart' as v_delivery_man_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/emergency_contract/controllers/emergency_contact_controller.dart' as v_emergency_contact_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/language/controllers/language_controller.dart' as v_language_controller;
import 'package:flutter_sixvalley_ecommerce/core/localization/controllers/localization_controller.dart' as v_localization_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/dashboard/controllers/bottom_menu_controller.dart' as v_bottom_menu_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/controllers/location_controller.dart' as v_location_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/order/controllers/order_controller.dart' as v_order_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/product/controllers/product_controller.dart' as v_product_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/review/controllers/product_review_controller.dart' as v_product_review_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/profile/controllers/profile_controller.dart' as v_profile_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/refund/controllers/refund_controller.dart' as v_refund_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/addProduct/controllers/add_product_controller.dart' as v_add_product_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shipping/controllers/shipping_controller.dart' as v_shipping_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/shop/controllers/shop_controller.dart' as v_shop_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/splash/controllers/splash_controller.dart' as v_splash_controller;
import 'package:flutter_sixvalley_ecommerce/core/theme/controllers/theme_controller.dart' as v_theme_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/bank_info/controllers/bank_info_controller.dart' as v_bank_info_controller;
import 'package:flutter_sixvalley_ecommerce/features/vendor/transaction/controllers/transaction_controller.dart' as v_transaction_controller;
import 'package:flutter_sixvalley_ecommerce/core/constants/app_constants.dart' as v_app_constants;
import 'package:flutter_sixvalley_ecommerce/common/controller/tutorial_controller.dart' as v_tutorial_controller;
...
Future<void> init() async {
  ...
  // Core
sl.registerLazySingleton(() => DioClient(v_app_constants.AppConstants.baseUrl, sl(), loggingInterceptor: sl(), sharedPreferences: sl()));
  ...
  // Interface
v_auth_repository_interface.AuthRepositoryInterface vendor_authRepoInterface = v_auth_repository.AuthRepository(dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => vendor_authRepoInterface);
v_bank_info_repository_interface.BankInfoRepositoryInterface bankInfoRepoInterface = v_bank_info_repository.BankInfoRepository(dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => bankInfoRepoInterface);
v_chat_repository_interface.ChatRepositoryInterface chatRepoInterface = v_chat_repository.ChatRepository(dioClient: sl());
  sl.registerLazySingleton(() => chatRepoInterface);
v_coupon_repository_interface.CouponRepositoryInterface couponRepoInterface = v_coupon_repository.CouponRepository(dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => couponRepoInterface);
v_delivery_man_repository_interface.DeliveryManRepositoryInterface deliveryManRepoInterface = v_delivery_man_repository.DeliveryManRepository(dioClient: sl());
  sl.registerLazySingleton(() => deliveryManRepoInterface);
v_emergency_contract_repository_interface.EmergencyContractRepositoryInterface emergencyContractRepoInterface = v_emergency_contact_repository.EmergencyContactRepository(dioClient: sl());
  sl.registerLazySingleton(() => emergencyContractRepoInterface);
v_order_repository_interface.OrderRepositoryInterface orderRepoInterface = v_order_repository.OrderRepository(dioClient: sl());
  sl.registerLazySingleton(() => orderRepoInterface);
v_product_repository_interface.ProductRepositoryInterface productRepoInterface = v_product_repository.ProductRepository(dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => productRepoInterface);
v_profile_repository_interface.ProfileRepositoryInterface profileRepoInterface = v_profile_repository.ProfileRepository(dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => profileRepoInterface);
v_refund_repository_interface.RefundRepositoryInterface refundRepoInterface = v_refund_repository.RefundRepository(dioClient: sl());
  sl.registerLazySingleton(() => refundRepoInterface);
v_product_review_repository_interface.ProductReviewRepositoryInterface productReviewRepoInterface = v_product_review_repository.ProductReviewRepository(dioClient: sl());
  sl.registerLazySingleton(() => productReviewRepoInterface);
v_buisness_repository_interface.BusinessRepositoryInterface businessRepoInterface = v_business_repository.BusinessRepository();
  sl.registerLazySingleton(() => businessRepoInterface);
v_shipping_repository_interface.ShippingRepositoryInterface shippingRepoInterface = v_shipping_repository.ShippingRepository(dioClient: sl());
  sl.registerLazySingleton(() => shippingRepoInterface);
v_add_product_repository_interface.AddProductRepositoryInterface addProductRepositoryInterface = v_add_product_repository.AddProductRepository(dioClient: sl());
  sl.registerLazySingleton(() => addProductRepositoryInterface);
v_splash_repository_interface.SplashRepositoryInterface splashRepoInterface = v_splash_repository.SplashRepository(dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => splashRepoInterface);
v_transaction_repository_interface.TransactionRepositoryInterface transactionRepoInterface = v_transaction_repository.TransactionRepository(dioClient: sl());
  sl.registerLazySingleton(() => transactionRepoInterface);
v_notification_repository_interface.NotificationRepositoryInterface notificationRepoInterface = v_notification_repository.NotificationRepository(dioClient: sl());
  sl.registerLazySingleton(() => notificationRepoInterface);
v_wallet_repository_interface.WalletRepositoryInterface walletRepoInterface = v_wallet_repository.WalletRepository(dioClient: sl());
  sl.registerLazySingleton(() => walletRepoInterface);
v_location_repository_interface.LocationRepositoryInterface vendor_locationRepositoryInterface = v_location_repository.LocationRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendor_locationRepositoryInterface);
v_cart_repository_interface.CartRepositoryInterface vendor_cartRepositoryInterface = v_cart_repository.CartRepository(dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => vendor_cartRepositoryInterface);
v_shop_repository_interface.ShopRepositoryInterface vendor_shopRepositoryInterface = v_shop_repository.ShopRepository(dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => vendor_shopRepositoryInterface);
v_order_details_repository_interface.OrderDetailsRepositoryInterface vendor_orderDetailsRepositoryInterface = v_order_details_repository.OrderDetailsRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendor_orderDetailsRepositoryInterface);
v_product_details_repository_interface.ProductDetailsRepositoryInterface vendor_productDetailsRepositoryInterface = v_product_details_repository.ProductDetailsRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendor_productDetailsRepositoryInterface);
v_barcode_reposity_interface.BarcodeRepositoryInterface barcodeRepositoryInterface = v_barcode_repository.BarcodeRepository(dioClient: sl());
  sl.registerLazySingleton(() => barcodeRepositoryInterface);
v_restock_repository_interface.RestockRepositoryInterface vendor_restockRepositoryInterface = v_restock_repository.RestockRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendor_restockRepositoryInterface);
v_clearance_sale_repository_interface.ClearanceSaleRepositoryInterface clearanceSaleRepositoryInterface = v_clearance_sale_repository.ClearanceSaleRepository(dioClient: sl());
  sl.registerLazySingleton(() => clearanceSaleRepositoryInterface);
v_category_repository_interface.CategoryRepositoryInterface categoryRepositoryInterface = v_category_repository.CategoryRepository(dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => categoryRepositoryInterface);
v_vat_repository_interface.VatRepositoryInterface vatRepositoryInterface = v_vat_repository.VatRepository(dioClient: sl());
  sl.registerLazySingleton(() => vatRepositoryInterface);
v_ai_repository_interface.AiRepositoryInterface aiRepositoryInterface = v_ai_repository.AiRepository(dioClient: sl());
  sl.registerLazySingleton(() => aiRepositoryInterface);
v_order_edit_repository_interface.OrderEditRepositoryInterface orderEditRepositoryInterface = v_order_edit_repository.OrderEditRepository(dioClient: sl());
  sl.registerLazySingleton(() => orderEditRepositoryInterface);
  AddAuctionProductRepositoryInterface vendor_addAuctionProductRepositoryInterface = AddAuctionProductRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendor_addAuctionProductRepositoryInterface);
v_auction_ai_repository_interface.AuctionAiRepositoryInterface vendor_auctionAiRepositoryInterface = v_auction_ai_repository.AuctionAiRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendor_auctionAiRepositoryInterface);
v_auction_product_repository_interface.AuctionProductRepositoryInterface auctionProductRepositoryInterface = v_auction_product_repository.AuctionProductRepository(dioClient: sl());
  sl.registerLazySingleton(() => auctionProductRepositoryInterface);

  // Services
v_auth_service_interface.AuthServiceInterface vendor_authServiceInterface = v_auth_service.AuthService(authRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_authServiceInterface);
v_bank_info_service_interface.BankInfoServiceInterface bankInfoServiceInterface = v_bank_info_service.BankInfoService(bankInfoRepoInterface: sl());
  sl.registerLazySingleton(() => bankInfoServiceInterface);
v_chat_service_interface.ChatServiceInterface vendor_chatServiceInterface = v_chat_service.ChatService(chatRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_chatServiceInterface);
v_coupon_service_interface.CouponServiceInterface vendor_couponServiceInterface = v_coupon_service.CouponService(couponRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_couponServiceInterface);
v_delivery_service_interface.DeliveryServiceInterface deliveryServiceInterface = v_delivery_service.DeliveryService(deliveryManRepoInterface: sl());
  sl.registerLazySingleton(() => deliveryServiceInterface);
v_emergency_contruct_service_interface.EmergencyServiceInterface emergencyServiceInterface = v_emergency_service.EmergencyService(emergencyContractRepoInterface: sl());
  sl.registerLazySingleton(() => emergencyServiceInterface);
v_order_service_interface.OrderServiceInterface vendor_orderServiceInterface = v_order_service.OrderService(orderRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_orderServiceInterface);
v_product_service_interface.ProductServiceInterface vendor_productServiceInterface = v_product_service.ProductService(productRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_productServiceInterface);
v_profice_service_interface.ProfileServiceInterface vendor_profileServiceInterface = v_profile_service.ProfileService(profileRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_profileServiceInterface);
v_refund_service_interface.RefundServiceInterface vendor_refundServiceInterface = v_refund_service.RefundService(refundRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_refundServiceInterface);
v_review_service_interface.ReviewServiceInterface vendor_reviewServiceInterface = v_review_service.ReviewService(productReviewRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_reviewServiceInterface);
v_business_service_interface.BusinessServiceInterface businessServiceInterface = v_business_service.BusinessService(businessRepoInterface: sl());
  sl.registerLazySingleton(() => businessServiceInterface);
v_shipping_service_interface.ShippingServiceInterface vendor_shippingServiceInterface = v_shipping_service.ShippingService(shippingRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_shippingServiceInterface);
v_add_product_service_interface.AddProductServiceInterface addProductServiceInterface = v_add_product_service.AddProductService(shopRepoInterface: sl());
  sl.registerLazySingleton(() => addProductServiceInterface);
v_splash_service_interface.SplashServiceInterface vendor_splashServiceInterface = v_splash_service.SplashService(splashRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_splashServiceInterface);
v_transaction_service_interface.TransactionServiceInterface vendor_transactionServiceInterface = v_transaction_service.TransactionService(transactionRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_transactionServiceInterface);

v_notification_service_interface.NotificationServiceInterface vendor_notificationServiceInterface = v_notification_service.NotificationService(notificationRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_notificationServiceInterface);
v_wallet_service_interface.WalletServiceInterface vendor_walletServiceInterface = v_wallet_service.WalletService(walletRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_walletServiceInterface);
v_location_service_interface.LocationServiceInterface vendor_locationServiceInterface = v_location_service.LocationService(locationRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendor_locationServiceInterface);
v_cart_service_interface.CartServiceInterface vendor_cartServiceInterface = v_cart_service.CartService(cartRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendor_cartServiceInterface);
v_shop_service_interface.ShopServiceInterface vendor_shopServiceInterface = v_shop_service.ShopService(shopRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendor_shopServiceInterface);
v_order_details_service_interface.OrderDetailsServiceInterface vendor_orderDetailsServiceInterface = v_order_details_service.OrderDetailsService(orderDetailsRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendor_orderDetailsServiceInterface);
v_product_details_service_interface.ProductDetailsServiceInterface vendor_productDetailsServiceInterface = v_product_details_service.ProductDetailsService(productDetailsRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendor_productDetailsServiceInterface);
v_barcode_service_interface.BarcodeServiceInterface barcodeServiceInterface = v_barcode_service.BarcodeService(barcodeRepositoryInterface: sl());
  sl.registerLazySingleton(() => barcodeServiceInterface);
v_restock_service_interface.RestockServiceInterface vendor_restockServiceInterface = v_restock_service.RestockService(restockRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendor_restockServiceInterface);
v_clearance_sale_service_interface.ClearanceSaleServiceInterface clearanceSaleServiceInterface = v_clearance_sale_service.ClearanceSaleService(clearanceSaleRepositoryInterface: sl());
  sl.registerLazySingleton(() => clearanceSaleServiceInterface);
v_category_service_interface.CategoryServiceInterface vendor_categoryServiceInterface = v_category_service.CategoryService(categoryRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendor_categoryServiceInterface);
v_vat_service_interface.VatServiceInterface vatServiceInterface = v_vat_service.VatService(vatRepoInterface: sl());
  sl.registerLazySingleton(() => vatServiceInterface);
v_ai_service_interface.AiServiceInterface aiServiceInterface = v_ai_service.AiService(aiRepositoryInterface: sl());
  sl.registerLazySingleton(() => aiServiceInterface);
v_order_edit_service_interface.OrderEditServiceInterface orderEditServiceInterface = v_order_edit_service.OrderEditService(orderEditRepositoryInterface: sl());
  sl.registerLazySingleton(() => orderEditServiceInterface);
  AddAuctionProductServiceInterface vendor_addAuctionProductServiceInterface = AddAuctionProductService(auctionRepoInterface: sl());
  sl.registerLazySingleton(() => vendor_addAuctionProductServiceInterface);
v_auction_ai_service_interface.AuctionAiServiceInterface vendor_auctionAiServiceInterface = v_auction_ai_service.AuctionAiService(auctionAiRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendor_auctionAiServiceInterface);
v_auction_product_service_interface.AuctionProductServiceInterface auctionProductServiceInterface = v_auction_product_service.AuctionProductService(auctionProductRepoInterface: sl());
  sl.registerLazySingleton(() => auctionProductServiceInterface);

  // Repository
sl.registerLazySingleton(() => v_auth_repository.AuthRepository(sharedPreferences: sl(), dioClient: sl()));
sl.registerLazySingleton(() => v_splash_repository.SplashRepository(sharedPreferences: sl(), dioClient: sl()));
sl.registerLazySingleton(() => v_profile_repository.ProfileRepository(dioClient: sl(), sharedPreferences: sl()));
sl.registerLazySingleton(() => v_shop_repository.ShopRepository(dioClient: sl(), sharedPreferences: sl()));
sl.registerLazySingleton(() => v_order_repository.OrderRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_bank_info_repository.BankInfoRepository(dioClient: sl(), sharedPreferences: sl()));
sl.registerLazySingleton(() => v_chat_repository.ChatRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_business_repository.BusinessRepository());
sl.registerLazySingleton(() => v_transaction_repository.TransactionRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_add_product_repository.AddProductRepository(dioClient: sl()));
  sl.registerLazySingleton(() => v_product_repository.ProductRepository(dioClient: sl(), sharedPreferences: sl()));
  sl.registerLazySingleton(() => v_product_review_repository.ProductReviewRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_shipping_repository.ShippingRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_delivery_man_repository.DeliveryManRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_refund_repository.RefundRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_cart_repository.CartRepository(dioClient: sl(),sharedPreferences: sl()));
sl.registerLazySingleton(() => v_emergency_contact_repository.EmergencyContactRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_location_repository.LocationRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_coupon_repository.CouponRepository(dioClient: sl(), sharedPreferences: sl()));
sl.registerLazySingleton(() => v_notification_repository.NotificationRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_wallet_repository.WalletRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_order_details_repository.OrderDetailsRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_product_details_repository.ProductDetailsRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_barcode_repository.BarcodeRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_restock_repository.RestockRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_clearance_sale_repository.ClearanceSaleRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_category_repository.CategoryRepository(dioClient: sl(), sharedPreferences: sl()));
sl.registerLazySingleton(() => v_vat_repository.VatRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_ai_repository.AiRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_order_edit_repository.OrderEditRepository(dioClient: sl()));
  sl.registerLazySingleton(() => AddAuctionProductRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_auction_ai_repository.AuctionAiRepository(dioClient: sl()));
sl.registerLazySingleton(() => v_auction_product_repository.AuctionProductRepository(dioClient: sl()));

  // Controller
sl.registerFactory(() => v_auth_controller.AuthController(authServiceInterface: sl()));
sl.registerFactory(() => v_bank_info_controller.BankInfoController(bankInfoServiceInterface: sl()));
sl.registerFactory(() => v_chat_controller.ChatController(chatServiceInterface: sl()));
sl.registerFactory(() => v_coupon_controller.CouponController(couponServiceInterface: sl()));
sl.registerFactory(() => v_delivery_man_controller.DeliveryManController(deliveryServiceInterface: sl()));
sl.registerFactory(() => v_emergency_contact_controller.EmergencyContactController(emergencyServiceInterface: sl()));
sl.registerFactory(() => v_order_controller.OrderController(orderServiceInterface: sl()));
sl.registerFactory(() => v_product_controller.ProductController(productServiceInterface: sl()));
sl.registerFactory(() => v_profile_controller.ProfileController(profileServiceInterface: sl()));
sl.registerFactory(() => v_refund_controller.RefundController(refundServiceInterface: sl()));
sl.registerFactory(() => v_product_review_controller.ProductReviewController(reviewServiceInterface: sl()));
sl.registerFactory(() => v_business_controller.BusinessController(businessServiceInterface: sl()));
sl.registerFactory(() => v_shipping_controller.ShippingController(shippingServiceInterface: sl()));
sl.registerFactory(() => v_add_product_controller.AddProductController(shopServiceInterface: sl()));
sl.registerFactory(() => v_splash_controller.SplashController(serviceInterface: sl()));
sl.registerFactory(() => v_transaction_controller.TransactionController(transactionServiceInterface: sl()));
sl.registerFactory(() => v_notification_controller.NotificationController(notificationServiceInterface: sl()));
sl.registerFactory(() => v_wallet_controller.WalletController(walletServiceInterface: sl()));
sl.registerFactory(() => v_order_details_controller.OrderDetailsController(orderDetailsServiceInterface: sl()));
sl.registerFactory(() => v_product_details_controller.ProductDetailsController(productDetailsServiceInterface: sl()));
sl.registerFactory(() => v_theme_controller.ThemeController(sharedPreferences: sl()));
sl.registerFactory(() => v_localization_controller.LocalizationController(sharedPreferences: sl()));
sl.registerFactory(() => v_language_controller.LanguageController());
sl.registerFactory(() => v_shop_controller.ShopController(shopServiceInterface: sl()));
sl.registerFactory(() => v_cart_controller.CartController(cartServiceInterface: sl()));
sl.registerFactory(() => v_bottom_menu_controller.BottomMenuController());
sl.registerFactory(() => v_location_controller.LocationController(locationServiceInterface: sl()));
sl.registerFactory(() => v_barcode_controller.BarcodeController(barcodeServiceInterface: sl()));
sl.registerFactory(() => v_restock_controller.RestockController(restockServiceInterface: sl()));
sl.registerFactory(() => v_clearance_sale_controller.ClearanceSaleController(chatServiceInterface: sl()));
  sl.registerFactory(() => CustomerController(cartServiceInterface: sl()));
sl.registerFactory(() => v_coupon_discount_controller.CouponDiscountController(cartServiceInterface: sl()));
sl.registerFactory(() => v_barcode_scan_controller.BarcodeScanController(cartServiceInterface: sl()));
  sl.registerFactory(() => ShowBottomSheetController());
sl.registerFactory(() => v_tutorial_controller.TutorialController());
sl.registerFactory(() => v_add_product_image_controller.AddProductImageController(shopServiceInterface: sl()));
sl.registerFactory(() => v_variation_controller.VariationController(addProductServiceInterface: sl()));
sl.registerFactory(() => v_digital_product_controller.DigitalProductController(addProductServiceInterface: sl()));
sl.registerFactory(() => v_category_controller.CategoryController(categoryServiceInterface: sl()));
sl.registerFactory(() => v_add_product_tax_controller.AddProductTaxController(addProductServiceInterface: sl()));
sl.registerFactory(() => v_vat_controller.VatController(vatServiceInterface: sl()));
sl.registerFactory(() => v_ai_controller.AiController(aiServiceInterface: sl()));
sl.registerFactory(() => v_order_edit_controller.OrderEditController(orderEditServiceInterface: sl()));
  sl.registerFactory(() => AddAuctionProductMediaController());
sl.registerFactory(() => v_auction_ai_controller.AuctionAiController(auctionAiServiceInterface: sl()));
sl.registerFactory(() => v_auction_product_controller.AuctionProductController(auctionProductServiceInterface: sl()));
  sl.registerFactory(() => AddAuctionProductController(addAuctionProductServiceInterface : sl()));
