import 'package:multishop_tchad/features/vendor/product/domain/services/product_service_interface.dart'
    as v_product_service_interface;
import 'package:multishop_tchad/features/vendor/product/domain/repositories/product_repository.dart'
    as v_product_repository;
import 'package:multishop_tchad/features/vendor/pos/controllers/customer_controller.dart';
import 'package:multishop_tchad/core/controllers/show_bottom_sheet_controller.dart';
import 'package:multishop_tchad/features/vendor/review/domain/repositories/product_review_repository.dart'
...
import 'package:multishop_tchad/features/vendor/third_party_deliveryman/domain/services/third_party_deliveryman_service.dart';
...
import 'package:multishop_tchad/features/vault/auction_details/domain/repositories/participator/auction_participation_repository_interface.dart';
...
import 'package:multishop_tchad/core/di/reposotories/data_sync_repo.dart';
import 'package:multishop_tchad/features/customer/cart/controllers/cart_controller.dart';
import 'package:multishop_tchad/features/customer/cart/domain/repositories/cart_repository.dart';
import 'package:multishop_tchad/features/vault/coupon/domain/services/coupon_service_interface.dart';
import 'package:multishop_tchad/features/customer/profile/domain/services/profile_service_interface.dart';
import 'package:multishop_tchad/features/vault/auction/domain/repository/customer_auction_list_repository.dart';
...
import 'package:multishop_tchad/core/di/data_sources/logging_interceptor.dart'
    as customer_interceptor;
import 'package:multishop_tchad/features/vault/deal/domain/repositories/featured_deal_repository.dart';
...
import 'package:multishop_tchad/features/vault/auction/domain/service/customer_auction_list_service.dart';
...
import 'package:multishop_tchad/features/vault/auction_category/domain/repositories/auction_category_repo.dart';
...
import 'package:multishop_tchad/core/di/reposotories/data_sync_repo_interface.dart';
import 'package:multishop_tchad/features/vault/auction_details/domain/services/creator/creator_auction_details_service.dart';
...
import 'package:multishop_tchad/features/vault/create_auction/domain/repository/add_auction_product_repository.dart';
import 'package:multishop_tchad/features/vault/auction_ai/domain/repository/auction_ai_repository_interface.dart';
...
import 'package:multishop_tchad/features/customer/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:multishop_tchad/features/vault/auction_transaction/domain/repository/auction_transaction_repository.dart';
import 'package:multishop_tchad/features/customer/splash/domain/repositories/splash_repository_interface.dart';
import 'package:multishop_tchad/features/vault/ai_shopping/domain/services/ai_shopping_service_interface.dart';
import 'package:multishop_tchad/features/vault/auction_details/controllers/creator/creator_auction_details_controller.dart';
import 'package:multishop_tchad/features/customer/splash/domain/services/splash_service.dart';
import 'package:multishop_tchad/features/vault/restock/controllers/restock_controller.dart';
import 'package:multishop_tchad/features/vault/review/controllers/review_controller.dart';
import 'package:multishop_tchad/features/vault/user_created_auction_list/controllers/user_created_auction_list_controller.dart';
import 'package:multishop_tchad/features/vault/auction_dashboard_summary/domain/services/auction_dashboard_summary_service.dart';
...
import 'package:multishop_tchad/features/vault/auction_ai/domain/services/auction_ai_service_interface.dart';
import 'package:multishop_tchad/features/vault/compare/domain/repositories/compare_repository.dart';
import 'package:multishop_tchad/features/vault/ai_shopping/controllers/ai_shopping_controller.dart';
...
import 'package:multishop_tchad/features/customer/product_details/domain/services/product_details_service_interface.dart';
...
import 'package:multishop_tchad/features/vault/auction_details/domain/services/participator/participation_auction_details_service.dart';
import 'package:multishop_tchad/features/customer/auth/domain/repositories/auth_repository.dart';
import 'package:multishop_tchad/features/vault/auction_transaction/domain/service/auction_transaction_service.dart';
...
import 'package:multishop_tchad/features/vault/review/domain/repositories/review_repository.dart';
import 'package:multishop_tchad/features/vault/ai_shopping/domain/services/ai_shopping_service.dart';
import 'package:multishop_tchad/features/vault/auction_dashboard_summary/domain/repository/auction_dashboard_summary_repository.dart';
import 'package:multishop_tchad/features/vault/restock/domain/services/restock_service_interface.dart';
import 'package:multishop_tchad/features/vault/auction_home/domain/repositories/auction_home_repo.dart';
import 'package:multishop_tchad/features/vault/loyaltyPoint/domain/repositories/loyalty_point_repository.dart';
...
import 'package:multishop_tchad/features/vault/auction_checkout/domain/repositories/auction_checkout_repository.dart';
import 'package:multishop_tchad/features/vault/review/domain/services/review_service.dart';
...
import 'package:multishop_tchad/features/customer/search_product/domain/repositories/search_product_repository.dart';
import 'package:multishop_tchad/features/customer/location/domain/services/location_service.dart';
import 'package:multishop_tchad/features/vault/support/domain/repositories/support_ticket_repository.dart';
import 'package:multishop_tchad/features/customer/onboarding/controllers/onboarding_controller.dart';
import 'package:multishop_tchad/features/customer/shop/domain/services/shop_service.dart';
import 'package:multishop_tchad/features/vault/auction_list/domain/repository/auction_product_queue_repository.dart';
...
import 'package:multishop_tchad/features/customer/auth/controllers/facebook_login_controller.dart';
...
import 'package:multishop_tchad/features/customer/product/domain/repositories/seller_product_repository.dart';
...
import 'package:multishop_tchad/core/guest/guest_mode_interceptor.dart';
import 'package:multishop_tchad/features/vault/transaction/domain/repository/transaction_repository.dart';
import 'package:multishop_tchad/features/vault/reorder/controllers/re_order_controller.dart';
import 'package:multishop_tchad/features/vault/auction_ai/domain/repository/auction_ai_repository.dart';
import 'package:multishop_tchad/features/vault/shipping/domain/services/shipping_service.dart';
import 'package:multishop_tchad/features/customer/brand/domain/services/brand_service.dart';
import 'package:multishop_tchad/features/customer/location/domain/services/location_service_interface.dart';
import 'package:multishop_tchad/features/vault/reorder/domain/services/re_order_service.dart';
import 'package:multishop_tchad/features/vault/compare/domain/repositories/compare_repository_interface.dart';
import 'package:multishop_tchad/features/customer/brand/domain/repositories/brand_repository.dart';
import 'package:multishop_tchad/features/vault/wishlist/domain/services/wishlist_service.dart';
import 'package:multishop_tchad/features/shared/notification/domain/repositories/notification_repository_interface.dart';
import 'package:multishop_tchad/features/customer/profile/domain/repositories/profile_repository.dart';
import 'package:multishop_tchad/core/theme/controllers/theme_controller.dart';
import 'package:multishop_tchad/features/customer/category/domain/repositories/category_repo.dart';
import 'package:multishop_tchad/features/customer/order/controllers/order_controller.dart';
import 'package:multishop_tchad/features/shared/notification/domain/repositories/notification_repository.dart';
import 'package:multishop_tchad/features/customer/checkout/domain/repositories/checkout_repository.dart';
import 'package:multishop_tchad/features/customer/cart/domain/services/cart_service.dart';
...
import 'package:multishop_tchad/features/vault/refund/domain/repositories/refund_repository.dart';
import 'package:multishop_tchad/features/vault/vat_tax/domain/service/vat_tax_service_interface.dart';
import 'package:multishop_tchad/features/vault/contact_us/controllers/contact_us_controller.dart';
...
import 'package:multishop_tchad/features/customer/location/controllers/location_controller.dart';
import 'package:multishop_tchad/features/shared/chat/domain/repositories/chat_repository.dart';
import 'package:multishop_tchad/features/vault/auction_ai/domain/services/auction_ai_service.dart';
import 'package:multishop_tchad/features/vault/shipping/domain/services/shipping_service_interface.dart';
import 'package:multishop_tchad/features/vault/support/domain/services/support_ticket_service.dart';
import 'package:multishop_tchad/core/helpers/network_info.dart';
import 'package:multishop_tchad/features/vault/transaction/controllers/transaction_controller.dart';
import 'package:multishop_tchad/features/customer/onboarding/domain/services/onboarding_service_interface.dart';
import 'package:multishop_tchad/features/vault/user_created_auction_list/domain/services/user_created_auction_list_service.dart';
import 'package:multishop_tchad/features/customer/category/domain/services/category_service.dart';
import 'package:multishop_tchad/features/vault/banner/domain/services/banner_service_interface.dart';
import 'package:multishop_tchad/features/customer/checkout/domain/services/checkout_service.dart';
...
import 'package:multishop_tchad/features/customer/order/domain/services/order_service.dart';
import 'package:multishop_tchad/features/vault/support/domain/repositories/support_ticket_repository_interface.dart';
import 'package:multishop_tchad/features/shared/chat/domain/repositories/chat_repository_interface.dart';
import 'package:multishop_tchad/core/di/datasource/remote/dio/logging_interceptor.dart';
import 'package:multishop_tchad/features/customer/auth/controllers/auth_controller.dart';
import 'package:multishop_tchad/features/vault/wishlist/domain/repositories/wishlist_repository.dart';
import 'package:multishop_tchad/features/vault/vat_tax/domain/repository/vat_tax_repository.dart';
import 'package:multishop_tchad/features/vault/deal/domain/repositories/flash_deal_repository_interface.dart';
import 'package:multishop_tchad/features/vault/deal/controllers/flash_deal_controller.dart';
import 'package:multishop_tchad/features/customer/product/domain/services/seller_product_service_interface.dart';
import 'package:multishop_tchad/features/customer/product_details/domain/repositories/product_details_repository.dart';
...
import 'package:multishop_tchad/features/customer/search_product/domain/services/search_product_service.dart';
import 'package:multishop_tchad/features/customer/splash/controllers/splash_controller.dart';
import 'package:multishop_tchad/features/vault/ai_shopping/domain/repository/ai_shopping_repository.dart';
import 'package:multishop_tchad/features/vault/loyaltyPoint/controllers/loyalty_point_controller.dart';
...
import 'package:multishop_tchad/features/customer/product/domain/repositories/product_repository.dart';
import 'package:multishop_tchad/features/vault/auction_search/domain/repositories/auction_search_repo.dart';
...
import 'package:multishop_tchad/features/vault/deal/domain/repositories/flash_deal_repository.dart';
import 'package:multishop_tchad/features/vault/deal/domain/services/featured_deal_service.dart';
...
import 'package:multishop_tchad/features/vault/transaction/domain/service/transaction_service.dart';
import 'package:multishop_tchad/features/vault/auction_checkout/domain/services/auction_checkout_service.dart';
...
import 'package:multishop_tchad/features/vault/create_auction/controllers/add_auction_product_media_controller.dart';
...
import 'package:multishop_tchad/features/vault/refund/controllers/refund_controller.dart';
import 'package:multishop_tchad/features/vault/auction_details/domain/services/participator/auction_participation_service_interface.dart';
...
import 'package:multishop_tchad/features/vault/loyaltyPoint/domain/services/loyalty_poin_service.dart';
...
import 'package:multishop_tchad/features/customer/order_details/domain/repositories/order_details_repository_interface.dart';
...
import 'package:multishop_tchad/features/shared/chat/domain/services/chat_service.dart';
...
import 'package:multishop_tchad/features/vault/auction_details/domain/repositories/participator/participation_auction_details_repository.dart';
...
import 'package:multishop_tchad/features/customer/onboarding/domain/services/onboarding_service.dart';
import 'package:multishop_tchad/features/vault/restock/domain/repositories/restock_repository.dart';
import 'package:multishop_tchad/features/customer/order/domain/repositories/order_repository.dart';
import 'package:multishop_tchad/features/vault/refund/domain/services/refund_service.dart';
...
import 'package:multishop_tchad/features/customer/product/domain/services/seller_product_service.dart';
import 'package:multishop_tchad/features/vault/auction/domain/service/customer_auction_list_service_interface.dart';
import 'package:multishop_tchad/features/vault/banner/domain/repositories/banner_repository.dart';
...
import 'package:multishop_tchad/features/customer/location/domain/repositories/location_repository.dart';
import 'package:multishop_tchad/features/vault/user_created_auction_list/domain/services/user_created_auction_list_service_interface.dart';
import 'package:multishop_tchad/features/vault/auction_search/domain/services/auction_search_service_interface.dart';
import 'package:multishop_tchad/features/vault/create_auction/domain/repository/add_auction_product_repository_interface.dart';
import 'package:multishop_tchad/core/di/services/data_sync_service_interface.dart';
import 'package:multishop_tchad/features/vault/compare/domain/services/compare_service.dart';
import 'package:multishop_tchad/features/customer/order_details/controllers/order_details_controller.dart';
import 'package:multishop_tchad/features/vault/shipping/domain/repositories/shipping_repository.dart';
import 'package:multishop_tchad/features/vault/create_auction/domain/services/add_auction_product_service.dart';
import 'package:multishop_tchad/features/vault/loyaltyPoint/domain/services/loyalty_point_service_interface.dart';
import 'package:multishop_tchad/features/vault/auction_home/controllers/auction_home_controller.dart';
import 'package:multishop_tchad/features/vault/vat_tax/domain/service/vat_tax_service.dart';
...
import 'package:multishop_tchad/features/customer/auth/domain/services/auth_service.dart';
import 'package:multishop_tchad/features/vault/shipping/controllers/shipping_controller.dart';
import 'package:multishop_tchad/features/customer/shop/domain/repositories/shop_repository.dart';
import 'package:multishop_tchad/features/vault/reorder/domain/repositories/re_order_repository.dart';
import 'package:multishop_tchad/features/customer/splash/domain/repositories/splash_repository.dart';
import 'package:multishop_tchad/features/shared/notification/controllers/notification_controller.dart';
import 'package:multishop_tchad/features/customer/product/domain/services/product_service.dart';
import 'package:multishop_tchad/features/customer/auth/controllers/google_login_controller.dart';
import 'package:multishop_tchad/features/vault/auction_category/controllers/auction_category_controller.dart';
import 'package:multishop_tchad/features/vault/banner/domain/services/banner_service.dart';
import 'package:multishop_tchad/features/customer/order_details/domain/services/order_details_service.dart';
import 'package:multishop_tchad/features/vault/auction_home/domain/services/auction_home_service.dart';
import 'package:multishop_tchad/features/vault/user_created_auction_list/domain/repository/user_created_auction_list_repository.dart';
...
import 'package:multishop_tchad/features/vault/loyaltyPoint/domain/repositories/loyalty_point_repository_interface.dart';
import 'package:multishop_tchad/features/vault/auction/controllers/customer_auction_list_controller.dart';
import 'package:multishop_tchad/features/vault/auction_search/domain/services/auction_search_service.dart';
import 'package:multishop_tchad/features/customer/profile/domain/repositories/profile_repository_interface.dart';
import 'package:multishop_tchad/features/vault/deal/domain/services/flash_deal_service.dart';
import 'package:multishop_tchad/features/vault/auction_list/domain/services/auction_product_queue_service_interface.dart';
import 'package:multishop_tchad/features/vault/auction_dashboard_summary/controllers/auction_dashboard_summary_controller.dart';
import 'package:multishop_tchad/features/vault/banner/domain/repositories/banner_repository_interface.dart';
...
import 'package:multishop_tchad/features/customer/product_details/domain/services/product_details_service.dart';
import 'package:multishop_tchad/features/vault/auction_details/domain/repositories/creator/creator_auction_details_repository.dart';
import 'package:multishop_tchad/features/vault/restock/domain/services/restock_service.dart';
import 'package:multishop_tchad/features/vault/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:multishop_tchad/features/customer/auth/domain/repositories/auth_repository_interface.dart';
import 'package:multishop_tchad/features/shared/notification/domain/services/notification_service.dart';
import 'package:multishop_tchad/features/customer/auth/domain/services/auth_service_interface.dart';
import 'package:multishop_tchad/features/vault/wallet/domain/services/wallet_service_interface.dart';
import 'package:multishop_tchad/features/vault/auction_list/domain/services/auction_product_queue_service.dart';
...
import 'package:multishop_tchad/features/vendor/ai/controllers/ai_controller.dart'
    as v_ai_controller;
import 'package:multishop_tchad/features/vendor/ai/domain/repositories/ai_repository.dart'
    as v_ai_repository;
...
import 'package:multishop_tchad/features/vendor/ai/domain/services/ai_service.dart'
    as v_ai_service;
import 'package:multishop_tchad/features/vendor/ai/domain/services/ai_service_interface.dart'
...
import 'package:multishop_tchad/features/vendor/auction/domain/repository/auction_ai_repository.dart'
...
import 'package:multishop_tchad/features/vendor/auction/domain/services/auction_ai_service.dart'
...
import 'package:multishop_tchad/features/vendor/auction/domain/repository/auction_product_repository.dart'
    as v_auction_product_repository;
import 'package:multishop_tchad/features/vendor/auction/domain/repository/auction_product_repository_interface.dart'
    as v_auction_product_repository_interface;
import 'package:multishop_tchad/features/vendor/auction/domain/services/auction_product_service.dart'
    as v_auction_product_service;
import 'package:multishop_tchad/features/vendor/auction/domain/services/auction_product_service_interface.dart'
    as v_auction_product_service_interface;
import 'package:multishop_tchad/features/vendor/auth/domain/repositories/auth_repository.dart'
...
import 'package:multishop_tchad/features/vendor/auth/domain/services/auth_service.dart'
    as v_auth_service;
...
import 'package:multishop_tchad/features/vendor/bank_info/domain/services/bank_info_service.dart'
...
import 'package:multishop_tchad/features/vendor/barcode/domain/repositories/barcode_repository.dart'
...
import 'package:multishop_tchad/features/vendor/barcode/domain/services/barcode_service.dart'
...
import 'package:multishop_tchad/features/vendor/chat/domain/services/chat_service.dart'
    as v_chat_service;
...
import 'package:multishop_tchad/features/vendor/clearance_sale/domain/repositories/clearance_sale_repository.dart'
...
import 'package:multishop_tchad/features/vendor/clearance_sale/domain/services/clearance_sale_service.dart'
...
import 'package:multishop_tchad/features/vendor/coupon/domain/services/coupon_service.dart'
    as v_coupon_service;
import 'package:multishop_tchad/features/vendor/coupon/domain/services/coupon_service_interface.dart'
...
import 'package:multishop_tchad/features/vendor/delivery_man/domain/services/delivery_service.dart'
...
import 'package:multishop_tchad/features/vendor/emergency_contract/domain/services/emergency_service.dart'
    as v_emergency_service;
import 'package:multishop_tchad/features/vendor/notification/controllers/notification_controller.dart'
    as v_notification_controller;
import 'package:multishop_tchad/features/vendor/notification/domain/repositories/notification_repository.dart'
...
import 'package:multishop_tchad/features/vendor/notification/domain/services/notification_service.dart'
...
import 'package:multishop_tchad/features/vendor/order/domain/repositories/location_repository_interface.dart'
...
import 'package:multishop_tchad/features/vendor/order/domain/services/location_service.dart'
...
import 'package:multishop_tchad/features/vendor/order/domain/services/order_service.dart'
    as v_order_service;
...
import 'package:multishop_tchad/features/vendor/order_details/domain/repositories/order_details_repository.dart'
    as v_order_details_repository;
import 'package:multishop_tchad/features/vendor/order_details/domain/repositories/order_details_repository_interface.dart'
    as v_order_details_repository_interface;
import 'package:multishop_tchad/features/vendor/order_details/domain/services/order_details_service.dart'
...
import 'package:multishop_tchad/features/vendor/order_edit/domain/repositories/order_edit_repository.dart'
...
import 'package:multishop_tchad/features/vendor/order_edit/domain/services/order_edit_service.dart'
...
import 'package:multishop_tchad/features/vendor/pos/controllers/barcode_scan_controller.dart'
    as v_barcode_scan_controller;
import 'package:multishop_tchad/features/vendor/pos/controllers/coupon_discount_controller.dart'
...
import 'package:multishop_tchad/features/vendor/pos/domain/services/cart_service.dart'
    as v_cart_service;
...
import 'package:multishop_tchad/features/vendor/product/domain/repositories/category_repository.dart'
...
import 'package:multishop_tchad/features/vendor/product/domain/repositories/product_repository_interface.dart'
    as v_product_repository_interface;
import 'package:multishop_tchad/features/vendor/product/domain/services/category_service.dart'
...
import 'package:multishop_tchad/features/vendor/product/domain/services/product_service.dart'
...
import 'package:multishop_tchad/features/vendor/product_details/domain/repositories/product_details_repository.dart'
...
import 'package:multishop_tchad/features/vendor/product_details/domain/services/product_details_service.dart'
...
import 'package:multishop_tchad/features/vendor/profile/domain/services/profile_service.dart'
...
import 'package:multishop_tchad/features/vendor/refund/domain/services/refund_service.dart'
    as v_refund_service;
...
import 'package:multishop_tchad/features/vendor/restock/domain/repositories/restock_repository.dart'
...
import 'package:multishop_tchad/features/vendor/restock/domain/services/restock_service.dart'
...
import 'package:multishop_tchad/features/vendor/review/domain/services/review_service.dart'
    as v_review_service;
...
import 'package:multishop_tchad/features/vendor/settings/domain/repositories/business_repository.dart'
    as v_business_repository;
import 'package:multishop_tchad/features/vendor/pos/domain/repository/cart_repository.dart'
    as v_cart_repository;
import 'package:multishop_tchad/features/vendor/chat/domain/repositories/chat_repository.dart'
    as v_chat_repository;
import 'package:multishop_tchad/features/vendor/coupon/domain/repositories/coupon_repository.dart'
    as v_coupon_repository;
import 'package:multishop_tchad/features/vendor/delivery_man/domain/repositories/delivery_man_repository.dart'
    as v_delivery_man_repository;
import 'package:multishop_tchad/features/vendor/emergency_contract/domain/repositories/emergency_contact_repository.dart'
    as v_emergency_contact_repository;
import 'package:multishop_tchad/features/vendor/order/domain/repositories/location_repository.dart'
    as v_location_repository;
import 'package:multishop_tchad/features/vendor/order/domain/repositories/order_repository.dart'
    as v_order_repository;
import 'package:multishop_tchad/features/vendor/profile/domain/repositories/profile_repository.dart'
    as v_profile_repository;
import 'package:multishop_tchad/features/vendor/refund/domain/repositories/refund_repository.dart'
    as v_refund_repository;
import 'package:multishop_tchad/features/vendor/settings/domain/services/business_service.dart'
...
import 'package:multishop_tchad/features/vendor/shipping/domain/services/shipping_service.dart'
...
import 'package:multishop_tchad/features/vendor/addProduct/domain/repository/add_product_repository.dart'
    as v_add_product_repository;
import 'package:multishop_tchad/features/vendor/shipping/domain/repositories/shipping_repository.dart'
    as v_shipping_repository;
import 'package:multishop_tchad/features/vendor/shop/domain/repositories/shop_repository.dart'
...
import 'package:multishop_tchad/features/vendor/addProduct/domain/services/add_product_service.dart'
...
import 'package:multishop_tchad/features/vendor/bank_info/domain/repositories/bank_info_repository.dart'
...
import 'package:multishop_tchad/features/vendor/transaction/domain/repositories/transaction_repository.dart'
...
import 'package:multishop_tchad/features/vendor/settings/controllers/business_controller.dart'
...
import 'package:multishop_tchad/features/vendor/transaction/domain/services/transaction_service.dart'
...
import 'package:multishop_tchad/features/vendor/vat_management/controllers/vat_controller.dart'
    as v_vat_controller;
import 'package:multishop_tchad/features/vendor/vat_management/domain/repositories/vat_repository.dart'
    as v_vat_repository;
...
import 'package:multishop_tchad/features/vendor/vat_management/domain/services/vat_service.dart'
    as v_vat_service;
...
import 'package:multishop_tchad/features/vendor/wallet/domain/repositories/wallet_repository.dart'
...
import 'package:multishop_tchad/features/vendor/wallet/domain/services/wallet_service.dart'
    as v_wallet_service;
...
Future<void> init() async {
  ...
  // External
  final vendorSharedpreferences = await SharedPreferences.getInstance();
  // sl.registerLazySingleton(() => vendor_sharedPreferences);
  // sl.registerLazySingleton(() => Dio());
  sl.registerLazySingleton(() => LoggingInterceptor());

  // Interface
  v_auth_repository_interface.AuthRepositoryInterface vendorAuthrepointerface =
      v_auth_repository.AuthRepository(
          dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => vendorAuthrepointerface);
  ...
  v_location_repository_interface.LocationRepositoryInterface
      vendorLocationrepositoryinterface =
      v_location_repository.LocationRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendorLocationrepositoryinterface);
  v_cart_repository_interface.CartRepositoryInterface
      vendorCartrepositoryinterface = v_cart_repository.CartRepository(
          dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => vendorCartrepositoryinterface);
  v_shop_repository_interface.ShopRepositoryInterface
      vendorShoprepositoryinterface = v_shop_repository.ShopRepository(
          dioClient: sl(), sharedPreferences: sl());
  sl.registerLazySingleton(() => vendorShoprepositoryinterface);
  v_order_details_repository_interface.OrderDetailsRepositoryInterface
      vendorOrderdetailsrepositoryinterface =
      v_order_details_repository.OrderDetailsRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendorOrderdetailsrepositoryinterface);
  v_product_details_repository_interface.ProductDetailsRepositoryInterface
      vendorProductdetailsrepositoryinterface =
      v_product_details_repository.ProductDetailsRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendorProductdetailsrepositoryinterface);
  ...
  v_restock_repository_interface.RestockRepositoryInterface
      vendorRestockrepositoryinterface =
      v_restock_repository.RestockRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendorRestockrepositoryinterface);
  ...
  AddAuctionProductRepositoryInterface
      vendorAddauctionproductrepositoryinterface =
      AddAuctionProductRepository(dioClient: sl());
//   sl.registerLazySingleton(() => vendor_addAuctionProductRepositoryInterface);
  v_auction_ai_repository_interface.AuctionAiRepositoryInterface
      vendorAuctionairepositoryinterface =
      v_auction_ai_repository.AuctionAiRepository(dioClient: sl());
  sl.registerLazySingleton(() => vendorAuctionairepositoryinterface);
  ...
  // Services
  v_auth_service_interface.AuthServiceInterface vendorAuthserviceinterface =
      v_auth_service.AuthService(authRepoInterface: sl());
  sl.registerLazySingleton(() => vendorAuthserviceinterface);
  ...
  v_chat_service_interface.ChatServiceInterface vendorChatserviceinterface =
      v_chat_service.ChatService(chatRepoInterface: sl());
  sl.registerLazySingleton(() => vendorChatserviceinterface);
  v_coupon_service_interface.CouponServiceInterface
      vendorCouponserviceinterface =
      v_coupon_service.CouponService(couponRepoInterface: sl());
  sl.registerLazySingleton(() => vendorCouponserviceinterface);
  ...
  v_shipping_service_interface.ShippingServiceInterface
      vendorShippingserviceinterface =
      v_shipping_service.ShippingService(shippingRepoInterface: sl());
  sl.registerLazySingleton(() => vendorShippingserviceinterface);
  ...
  v_restock_service_interface.RestockServiceInterface
      vendorRestockserviceinterface =
      v_restock_service.RestockService(restockRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendorRestockserviceinterface);
  ...
  v_category_service_interface.CategoryServiceInterface
      vendorCategoryserviceinterface =
      v_category_service.CategoryService(categoryRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendorCategoryserviceinterface);
  ...
  AddAuctionProductServiceInterface vendorAddauctionproductserviceinterface =
      AddAuctionProductService(auctionRepoInterface: sl());
// //   sl.registerLazySingleton(() => vendor_addAuctionProductServiceInterface);
  v_auction_ai_service_interface.AuctionAiServiceInterface
      vendorAuctionaiserviceinterface =
      v_auction_ai_service.AuctionAiService(auctionAiRepositoryInterface: sl());
  sl.registerLazySingleton(() => vendorAuctionaiserviceinterface);
