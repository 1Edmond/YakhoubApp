...
import 'package:flutter_sixvalley_ecommerce/features/vendor/chat/screens/media_viewer_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/chat/widgets/chat_shimmer_widget.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/vendor/chat/widgets/message_bubble_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/chat/widgets/send_message_widget.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                if(chatController.pickedFIleCrossMaxLimit || chatController.pickedImageCrossMaxLength || chatController.singleFIleCrossMaxLimit)
                  Text( "${chatController.pickedImageCrossMaxLength ? "â€¢ ${getTranslated('can_not_select_more_than', context)!} ${AppConstants.maxLimitOfTotalFileSent.floor()} 'files' " :""} "
                      "${chatController.pickedFIleCrossMaxLimit ? "â€¢ ${getTranslated('total_images_size_can_not_be_more_than', context)!} ${AppConstants.maxLimitOfFileSentINConversation.floor()} MB" : ""} "
                      "${chatController.singleFIleCrossMaxLimit ? "â€¢ ${getTranslated('single_file_size_can_not_be_more_than', context)!} "
              ...
              child: Column(
                ...
                children: [
                  ...
                  if(chatController.pickedFIleCrossMaxLimit || chatController.pickedFIleCrossMaxLength || chatController.singleFIleCrossMaxLimit)
                    Text( "${chatController.pickedFIleCrossMaxLength ? "â€¢ ${getTranslated('can_not_select_more_than', context)!} ${AppConstants.maxLimitOfTotalFileSent.floor()} 'files' " :""} "
                        "${chatController.pickedFIleCrossMaxLimit ? "â€¢ ${getTranslated('total_images_size_can_not_be_more_than', context)!} ${Provider.of<SplashController>(Get.context!, listen: false).configModel?.systemGeneralFileUploadMaxSize ?? AppConstants.maxLimitOfFileSentINConversation.floor()} MB" : ""} "
                        "${chatController.singleFIleCrossMaxLimit ? "â€¢ ${getTranslated('single_file_size_can_not_be_more_than', context)!} ${Provider.of<SplashController>(Get.context!, listen: false).configModel?.systemGeneralFileUploadMaxSize ?? AppConstants.maxSizeOfASingleFile.floor()} MB" : ""} ",
                      style: robotoRegular.copyWith(
                        fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).colorScheme.error,
                      ),
                    ),
