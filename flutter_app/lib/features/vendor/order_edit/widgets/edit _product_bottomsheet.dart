...
import 'package:multishop_tchad/core/widgets/base/basewidgets/custom_directionality_widget.dart';
...
class EditProductCartBottomSheetWidgetState extends State<EditProductCartBottomSheetWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    ({double? end, double? start})? priceRange = ProductHelper.getVendorProductPriceRange(widget.product);
