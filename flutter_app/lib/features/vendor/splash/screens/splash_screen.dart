...
import 'package:flutter_sixvalley_ecommerce/features/vendor/notification/screens/notification_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/order_details/screens/order_details_screen.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/vendor/refund/screens/refund_details_screen.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/vendor/splash/widgets/splash_painter_widget.dart';
          ...
          if(compareVersions(minimumVersion, AppConstants.appVersion) == 1) {
            ...
            if(widget.body != null) {
              ...
              switch(notificationType.toLowerCase()) {
                ...
                case 'refund' : {
                  Navigator.of(Get.context!).pushReplacement(MaterialPageRoute(builder: (context) =>  RefundDetailsScreen(fromNotification: true, refundModel: RefundModel(id: int.tryParse(widget.body!.refundId.toString())), orderDetailsId: int.tryParse(widget.body!.orderDetailsId.toString()))));
                }
                break;
