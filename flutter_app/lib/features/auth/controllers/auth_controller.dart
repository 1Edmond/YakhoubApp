...
import 'package:multishop_tchad/features/auth/domain/models/register_model.dart';
...
import 'package:multishop_tchad/features/auth/domain/models/signup_model.dart';
import 'package:multishop_tchad/features/auth/domain/models/social_login_model.dart';
import 'package:multishop_tchad/features/auth/domain/models/user_log_data.dart';
import 'package:multishop_tchad/features/auth/domain/services/auth_service_interface.dart';
...
import 'package:multishop_tchad/features/customer/home/screens/aster_theme_home_screen.dart';
...
import 'package:multishop_tchad/core/localization/app_localization.dart';
...
class AuthController with ChangeNotifier {
  ...
  Future<void> socialLogin(SocialLoginModel socialLogin, Function callback,
      String? fromPage, VoidCallback? onLoginSuccess) async {
    _isLoading = true;
    notifyListeners();
      ...
      if (token != null && token.isNotEmpty) {
        ...
        setCurrentLanguage(
            Provider.of<LocalizationController>(Get.context!, listen: false)
                    .getCurrentLanguage() ??
                'en');
        Provider.of<AiShoppingController>(Get.context!, listen: false)
            .clearSession();
  ...
  Future<ResponseModel> login(
      String? userInput, String? password, String? type, FromPage? fromPage,
  ...
  Future<ResponseModel> checkEmail(String email, FromPage? fromPage,
      {String? toNavigateScreen, VoidCallback? onLoginSuccess}) async {
    _isPhoneNumberVerificationButtonLoading = true;
    _resendButtonLoading = true;
  ...
  Future<ResponseModel> checkPhone(String phone, FromPage? fromPage,
      {String? toNavigateScreen, VoidCallback? onLoginSuccess}) async {
    _isPhoneNumberVerificationButtonLoading = true;
    _verificationMsg = '';
    notifyListeners();
      ...
      if (isForgetPassword) {
        ...
        if (_isActiveRememberMe) {
          saveUserEmailAndPassword(UserLogData(
              ...
              phoneNumber: CountryCodeHelper.extractPhoneNumber(
    ...
    if (fromPage != null) {
      if (fromPage.startsWith('/dashboard')) {
        ...
        RouterHelper.getDashboardRoute(
            action: RouteAction.pushReplacement, page: pageParam ?? 'home');
