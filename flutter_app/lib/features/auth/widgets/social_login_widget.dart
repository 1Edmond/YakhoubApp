...
import 'package:multishop_tchad/features/auth/enums/social_login_options.dart';
import 'package:multishop_tchad/features/auth/widgets/existing_account_bottom_sheet.dart';
...
import 'package:multishop_tchad/features/auth/controllers/facebook_login_controller.dart';
import 'package:multishop_tchad/features/auth/controllers/google_login_controller.dart';
...
class SocialLoginWidgetState extends State<SocialLoginWidget> {
  ...
  Widget build(BuildContext context) {
    return const SizedBox.shrink(); // Hidden per requirements
