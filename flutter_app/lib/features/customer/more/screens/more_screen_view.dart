...
import 'package:flutter_sixvalley_ecommerce/features/customer/more/widgets/profile_info_section_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/customer/more/widgets/more_horizontal_section_widget.dart';
import 'package:provider/provider.dart';
import 'package:flutter_sixvalley_ecommerce/features/customer/more/widgets/title_button_widget.dart';
                        ...
                        return Padding(padding:  const EdgeInsets.all(Dimensions.paddingSizeDefault),
                          child: Container(padding:  const EdgeInsets.all(Dimensions.paddingSizeSmall),
                            ...
                            child: Column(children: [
                              ...
                              Visibility(visible: false, child: MenuButtonWidget(image: Images.coupon, title: getTranslated('coupons', context),
                                onTap: () {
                              ...
                              if(splashController.configModel!.activeTheme != "default" && authController.isLoggedIn())
                                Visibility(visible: false, child: MenuButtonWidget(image: Images.compare, title: getTranslated('compare_products', context),
                                  onTap: () {
