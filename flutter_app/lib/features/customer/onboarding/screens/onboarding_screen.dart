...
class OnBoardingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _OnBoardingScreenContent(indicatorColor: indicatorColor, selectedIndicatorColor: selectedIndicatorColor);
  }
}
...
class _OnBoardingScreenContent extends StatelessWidget {
  ...
  _OnBoardingScreenContent({required this.indicatorColor, required this.selectedIndicatorColor});
