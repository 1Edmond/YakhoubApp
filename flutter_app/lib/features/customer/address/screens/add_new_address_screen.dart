...
import 'package:multishop_tchad/features/auth/widgets/code_picker_widget.dart';
...
import 'package:multishop_tchad/features/customer/splash/domain/models/config_model.dart' as config;
...
import 'package:multishop_tchad/core/helpers/velidate_check.dart';
...
import 'package:multishop_tchad/core/widgets/base/success_dialog_widget.dart';
                      ...
                      child: Form(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const SizedBox(height: Dimensions.paddingSizeDefaultAddress),
                                                    ...
                                                    // Photo de la porte (Tchad Requirement)
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Photo de la porte (Obligatoire)", style: textRegular.copyWith(fontSize: 14)),
                                    ...
                                    child: Center(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text("Prendre une photo de votre porte", style: textRegular),
                                        ],
                                      ),
                                    ),
                                  ),
